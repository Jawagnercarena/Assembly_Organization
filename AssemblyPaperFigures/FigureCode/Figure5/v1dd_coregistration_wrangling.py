...
def get_cell_and_coregistration_table():
    ...
    timestamp = client.materialize.get_version_metadata(version=700)[
        'time_stamp']
...
def get_tables_and_mappings(online=True):
    ...
    print(assemblies_by_connectome_id)
...
#get_tables_and_mappings(online=True)