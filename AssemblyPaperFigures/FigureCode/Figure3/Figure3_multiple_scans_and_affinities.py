...
for scan in [12, 13, 14]:
    for affinity in [4]:
        if not os.path.exists(f'/home/berteau/neuro/HebbsVision/FigureCode/Figure3/scan{scan}_affinity{affinity}'):
            os.makedirs(f'/home/berteau/neuro/HebbsVision/FigureCode/Figure3/scan{scan}_affinity{affinity}')

        # %%
        # dF_trace = np.load("/media/berteau/Elements/sessionM409828_{scan}_nm_dff.npy")[0,:,:]
        dF_trace = np.load(f"/home/berteau/neuro/HebbsVision/data_files/v1dd/functional/final/sessionM409828_{scan}_dff.npy") # stefan extracted
        ...
        # %%
        # file_string = f"/home/berteau/neuro/HebbsVision/data_files/v1dd/functional/final/esteps_150000_affinity_0{affinity}_sessionM409828_{scan}_SGC-ASSEMBLIES.mat"
        # print(file_string)
        # scipy.io.loadmat(file_string)


        # %%
        ACTIVITY_RASTER = scipy.io.loadmat(
            f"/home/berteau/neuro/HebbsVision/data_files/v1dd/functional/final/session{scan}_affinity0{affinity}_ACTIVITY-RASTER.mat", struct_as_record=True, squeeze_me=True)
        SGC_ASSEMBLIES = scipy.io.loadmat(
            f"/home/berteau/neuro/HebbsVision/data_files/v1dd/functional/final/esteps_150000_affinity_0{affinity}_sessionM409828_{scan}_SGC-ASSEMBLIES.mat", struct_as_record=True, squeeze_me=True)
        ...
        assemblies = [np.atleast_1d(A) - 1 for A in assemblies]
        ...
        temp_fig = get_assembly_time_trace(assembly_coactivity_trace, None)
        plt.savefig(f"/home/berteau/neuro/HebbsVision/FigureCode/Figure3/scan{scan}_affinity{affinity}/assembly_coactivity_trace.png", dpi=300)

        # %%
        def _get_filenames_starting_with(directory_path, prefix):
        ...
        def _find_highest_numbered_file(directory, match_string):
                # Get a list of all files in the directory
                files = _get_filenames_starting_with(directory, match_string)
        ...
        # %%
        file_name = _get_filenames_starting_with('/home/berteau/neuro/HebbsVision/data_files/v1dd/functional/final/', f'M409828_{scan}')[0]
        nwb_f = h5py.File('/home/berteau/neuro/HebbsVision/data_files/v1dd/functional/final/'+file_name, 'r')
        import v1dd_physiology.data_fetching as daf
        ...
        for curr_dict, oracle_array, c in zip([pika_rois_all_dict, pika_rois_in_assembly_dict, pika_rois_no_assembly_dict], 
            ...
            for plane_n, pika_roi_ns in curr_dict.items():
                for roi_n in pika_roi_ns:
                    ...
                    nm_data = np.array(presentation['natural_movie'].get('data'))[:-900] 
        ...
        plt.savefig(f'/home/berteau/neuro/HebbsVision/FigureCode/Figure3/scan{scan}_affinity{affinity}/assemblies_esteps_150000__affinity_03_session'+str(13)+'_movies.png')
        plt.show()
        ...
        plt.savefig(f'/home/berteau/neuro/HebbsVision/FigureCode/Figure3/scan{scan}_affinity{affinity}/oracle_scores_histogram_f_subtracted.png', dpi = 1200)
        plt.show()
        plt.close()

        np.save(f'/home/berteau/neuro/HebbsVision/FigureCode/Figure3/oracle_dists/scan{scan}_affinity{affinity}_assemblies_natural_movie_oracle_r_values.npy', movie_oracle_r_values)
        np.save(f'/home/berteau/neuro/HebbsVision/FigureCode/Figure3/oracle_dists/scan{scan}_affinity{affinity}_assemblies_natural_movie_oracle_r_values.npy', mean_over_holdouts)


        # %%
        np.save(f'/home/berteau/neuro/HebbsVision/FigureCode/Figure3/oracle_dists/scan{scan}_affinity{affinity}_assemblies_natural_movie_oracle_r_values.npy', movie_oracle_r_values)
        np.save(f'/home/berteau/neuro/HebbsVision/FigureCode/Figure3/oracle_dists/scan{scan}_affinity{affinity}_assemblies_natural_movie_oracle_scores.npy', mean_over_holdouts)


        # %%
        print(len(neuron_in_assembly_movie_oracle_r_values))
        ...
        def get_assembly_time_trace(coactivity_trace, scores_in_order, name='scored_time_trace'):
            ...
            fig.suptitle("Assembly Time Trace")
            plt.savefig(f'/home/berteau/neuro/HebbsVision/FigureCode/Figure3/scan{scan}_affinity{affinity}/assemblies_{name}.png', dpi = 1200)


        # %%
        # ACTIVITY_RASTER = scipy.io.loadmat(
        #     f"/home/berteau/neuro/HebbsVision/data_files/v1dd/functional/final/session{scan}_ACTIVITY-RASTER.mat", struct_as_record=True, squeeze_me=True)
        # print(ACTIVITY_RASTER['activity_raster'].shape)
        ...
        # ACTIVITY_RASTER = scipy.io.loadmat(
        #     "/home/berteau/neuro/HebbsVision/data_files/v1dd/functional/final/esteps_150000_affinity_03_sessionM409828_12_ACTIVITY-RASTER_bak.mat", struct_as_record=True, squeeze_me=True)
        # print(ACTIVITY_RASTER['activity_raster'].shape)

        # %%
        scores_in_order = np.load(f'/home/berteau/neuro/HebbsVision/FigureCode/Figure3/oracle_dists/scan{scan}_affinity{affinity}_assemblies_natural_movie_oracle_r_values.npy')
        ...
        dF_trace = np.load(f"/home/berteau/neuro/HebbsVision/data_files/v1dd/functional/final/sessionM409828_{scan}_dff.npy")
        ...
        # %%
        with open(f'random_ensembles_{scan}_{affinity}.pkl', 'wb') as f:
        ...
        ACTIVITY_RASTER = scipy.io.loadmat(
            f"/home/berteau/neuro/HebbsVision/data_files/v1dd/functional/final/esteps_150000_affinity_0{affinity}_sessionM409828_{scan}_ACTIVITY-RASTER.mat", struct_as_record=True, squeeze_me=True)
        ...
        def get_ensemble_time_trace(coactivity_trace, title):
            ...
            fig.suptitle(title)
            plt.savefig(f'/home/berteau/neuro/HebbsVision/FigureCode/Figure3/scan{scan}_affinity{affinity}/assemblies_esteps_150000_affinity_03_{name}.png', dpi = 1200)


        # %%
        ### Plot the assembly coactivity traces in order
        # scores_in_order = np.load('oracle_dists/assemblies_esteps_150000_affinity_03_session12_natural_movie_oracle_scores.npy')
        ...
        # scores_in_order = np.load(f'/home/berteau/neuro/HebbsVision/FigureCode/Figure3/oracle_dists/assemblies_esteps_150000_affinity_0{affinity}_session{scan}_natural_movie_oracle_scores.npy')
        ...
        # plt.title(f"Intersection of Random Ensembles in Scan {scan} affinity {affinity} of V1DD", size = 24)
        ...
        # Indexes of coregistered neurons in overall activity raster
        coregistered_neurons = set()
        for A in assemblies:
            for neuron_id in A - 1:  # Correct for Python Indexing
                coregistered_neurons.add(neuron_id)
        coregistered_correlations = raster_pearson[np.array(list(coregistered_neurons)), :][:, np.array(list(coregistered_neurons))]
        np.save(f'/home/berteau/neuro/HebbsVision/FigureCode/Figure3/scan{scan}_affinity{affinity}_coregistered_assembly_neuron_correlations.npy', coregistered_correlations)
        ...
        np.save('/home/berteau/neuro/HebbsVision/FigureCode/Figure3/oracle_dists/assembly_r_scores.npy', assembly_r_scores)
        np.save('/home/berteau/neuro/HebbsVision/FigureCode/Figure3/oracle_dists/null_r_scores.npy', null_r_scores)
        np.save('/home/berteau/neuro/HebbsVision/FigureCode/Figure3/oracle_dists/raster_pearson.npy', raster_pearson)
        ...
        statistic_assembly_null = stats.ranksums(np.array(assembly_r_scores).flatten(), np.array(null_r_scores).flatten(), alternative='two-sided').statistic
        statistic_assembly_all = stats.ranksums(np.array(assembly_r_scores).flatten(), np.array(all_cell_r_scores).flatten(), alternative='two-sided').statistic
        statistic_assembly_a = stats.ranksums(np.array(assembly_r_scores).flatten(), np.array(a_cell_r_scores).flatten(), alternative='two-sided').statistic
        statistic_assembly_no_a = stats.ranksums(np.array(assembly_r_scores).flatten(), np.array(no_a_cell_r_scores).flatten(), alternative='two-sided').statistic
        statistic_a_no_a = stats.ranksums(np.array(a_cell_r_scores).flatten(), np.array(no_a_cell_r_scores).flatten(), alternative='two-sided').statistic
        statistic_all_v_a = stats.ranksums(np.array(all_cell_r_scores).flatten(), np.array(a_cell_r_scores).flatten(), alternative='two-sided').statistic
        ...
        n1_values = [len(assembly_r_scores), len(assembly_r_scores), len(assembly_r_scores), len(assembly_r_scores), len(a_cell_r_scores), len(all_cell_r_scores)]
        n2_values = [len(null_r_scores), len(all_cell_r_scores), len(a_cell_r_scores), len(no_a_cell_r_scores), len(no_a_cell_r_scores), len(a_cell_r_scores)]

        test_statistics = [statistic_assembly_null, statistic_assembly_all, statistic_assembly_a, statistic_assembly_no_a, statistic_assembly_no_a, statistic_a_no_a, statistic_all_v_a]
        # 
        ...
        print(f'All Cells vs Assembly Cells: {stats.ranksums(np.array(all_cell_r_scores).flatten(), np.array(a_cell_r_scores).flatten(), alternative="two-sided")}')
        # 
        ...
        for i, label in enumerate(["Assembly vs. Random Ensembles", "Assembly vs. All Cells", "Assembly vs. Assembly Cells", "Assembly vs. Non-Assembly Cells", "Assembly Cells vs. Non-Assembly Cells", "Assembly Cells vs. All Cells"]):
            print(label)

        for i, label in enumerate(["Assembly vs. Random Ensembles", "Assembly vs. All Cells", "Assembly vs. Assembly Cells", "Assembly vs. Non-Assembly Cells", "Assembly Cells vs. Non-Assembly Cells", "Assembly Cells vs. All Cells"]):
            print(f"{n1_values[i]} vs. {n2_values[i]}")

        for i, label in enumerate(["Assembly vs. Random Ensembles", "Assembly vs. All Cells", "Assembly vs. Assembly Cells", "Assembly vs. Non-Assembly Cells", "Assembly Cells vs. Non-Assembly Cells", "Assembly Cells vs. All Cells"]):
            print(f"{test_statistics[i]:.4g}")

        for i, label in enumerate(["Assembly vs. Random Ensembles", "Assembly vs. All Cells", "Assembly vs. Assembly Cells", "Assembly vs. Non-Assembly Cells", "Assembly Cells vs. Non-Assembly Cells", "Assembly Cells vs. All Cells"]):
            print(f"{p_value_array[i]:.4g}, BH corrected: {corrected_p_value_array[1][i]:.4g}")
        ...
        for p_index, p_value in enumerate(corrected_p_value_array[1]):
            if p_value < 0.001:
        ...
        print('Decoding...')
        nwb_f = h5py.File('/home/berteau/neuro/HebbsVision/data_files/v1dd/functional/final/M409828_12.nwb', 'r')
        ...
        nm_timestamps = np.array(
            presentation['natural_movie'].get('timestamps'))
        nm_data = np.array(presentation['natural_movie'].get('data'))[:-900]  # columns name dataset, gives you the start time, the end time, and the frame number for the natural movie data that was presented
        ...
        # plt.ylabel('Truth')
        # plt.yticks(rotation=0)
        # plt.savefig(f'/home/berteau/neuro/HebbsVision/FigureCode/Figure3/scan{scan}_affinity{affinity}//random_ensemble_clip_id_decoder_MLPClassifier.png', dpi = 1200)
        # plt.show()
        ...
        # plt.ylabel('Truth')
        # plt.yticks(rotation=0)
        # plt.savefig(f'/home/berteau/neuro/HebbsVision/FigureCode/Figure3/scan{scan}_affinity{affinity}//random_ensemble_clip_id_percentage_decoder_MLPClassifier.png', dpi = 1200)
        # plt.show()
        ...
        for clip_id in unique_clip_ids:
            ...
            print(np.max(sampled_indices))
            for sampled_index in sampled_indices:
                if sampled_index < assembly_coactivity_time_traces.shape[0]:
                    balanced_assembly_coactivations.extend(assembly_coactivity_time_traces[sampled_index])
        ...
        plt.savefig(f'/home/berteau/neuro/HebbsVision/FigureCode/Figure3/scan{scan}_affinity{affinity}/assembly_balanced_clip_id_decoder_MLPClassifier.png', dpi = 1200)
        plt.savefig(f'/home/berteau/neuro/HebbsVision/FigureCode/Figure3/scan{scan}_affinity{affinity}/assembly_balanced_clip_id_decoder_MLPClassifier.pdf')
        plt.show()
        ...
        plt.yticks(rotation=0, fontsize=18)
        plt.xticks(fontsize=18) 
        plt.savefig(f'/home/berteau/neuro/HebbsVision/FigureCode/Figure3/scan{scan}_affinity{affinity}//assembly_balanced_clip_id_percentage_decoder_MLPClassifier.png', dpi = 1200)
        plt.savefig(f'/home/berteau/neuro/HebbsVision/FigureCode/Figure3/scan{scan}_affinity{affinity}//assembly_balanced_clip_id_percentage_decoder_MLPClassifier.pdf')
        plt.show()
        ...
        plt.yticks(rotation=0, fontsize=18)
        plt.xticks(fontsize=18)
        plt.savefig(f'/home/berteau/neuro/HebbsVision/FigureCode/Figure3/scan{scan}_affinity{affinity}//random_ensemble_balanced_clip_id_decoder_MLPClassifier.png', dpi = 1200)
        plt.savefig(f'/home/berteau/neuro/HebbsVision/FigureCode/Figure3/scan{scan}_affinity{affinity}//random_ensemble_balanced_clip_id_decoder_MLPClassifier.pdf')
        plt.close()
        ...
        plt.yticks(rotation=0, fontsize=18)
        plt.xticks(fontsize=18)
        plt.savefig(f'/home/berteau/neuro/HebbsVision/FigureCode/Figure3/scan{scan}_affinity{affinity}//asdf_random_ensemble_balanced_clip_id_decoder_MLPClassifier.png', dpi = 1200)
        plt.savefig(f'/home/berteau/neuro/HebbsVision/FigureCode/Figure3/scan{scan}_affinity{affinity}//asdf_random_ensemble_balanced_clip_id_decoder_MLPClassifier.pdf')
        plt.close()
        ...
        plt.yticks(rotation=0, fontsize=18)
        plt.xticks(fontsize=18)
        plt.savefig(f'/home/berteau/neuro/HebbsVision/FigureCode/Figure3/scan{scan}_affinity{affinity}//random_ensemble_balanced_clip_id_percentage_decoder_MLPClassifier.png', dpi = 1200)
        plt.savefig(f'/home/berteau/neuro/HebbsVision/FigureCode/Figure3/scan{scan}_affinity{affinity}//random_ensemble_balanced_clip_id_percentage_decoder_MLPClassifier.pdf')
        plt.close()
            ...
            for plane_n, pika_roi_ns in curr_dict.items():
                for roi_n in pika_roi_ns:
                    ...
                    for trial_idx in range(trial_fluorescence_np.shape[0]):
                        ...
                        #     print("\nFrames to Capture", frames_to_capture)
                        #     print("\nFluorescence", trial_fluorescence_np)
                        #     print("\nRemoved", removed_trial)
                        #     print("\nRemaining", remaining_trials)
                        #     print("\nRemaining Mean", np.mean(remaining_trials, 0))
        ...
        plt.ylabel('Frequency')
        plt.hist(mean_over_holdouts[:], bins=50)
        #plt.savefig(f'/home/berteau/neuro/HebbsVision/FigureCode/Figure3/scan{scan}_affinity{affinity}///home/berteau/neuro/HebbsVision/FigureCode/Figure3/oracle_dists/assemblies_esteps_150000__affinity_03_session'+str(13)+'_movies.png')
        plt.show()
        ...
        test_statistics = []
        for group in groups:
            group1_values = data[data["Group"] == "Assemblies"]["Values"]
            group1_values = group1_values[~np.isnan(group1_values)]
            group2_values = data[data["Group"] == group]["Values"]
            group2_values = group2_values[~np.isnan(group2_values)]
            p_value = stats.ranksums(group1_values, group2_values, alternative='two-sided').pvalue
            test_stat = stats.ranksums(group1_values, group2_values, alternative='two-sided').statistic
            # print(f"p-value for Assemblies greater than {group}: {p_value:.3g}")
            p_values.append(p_value)
            n1_values.append(len(group1_values))
            n2_values.append(len(group2_values))
            test_statistics.append(test_stat)

        # All cells vs assembly cells
        group1_values = data[data["Group"] == "All\nCells"]["Values"]
        group1_values = group1_values[~np.isnan(group1_values)]
        group2_values = data[data["Group"] == "Assembly\nCells"]["Values"]
        group2_values = group2_values[~np.isnan(group2_values)]
        p_value = stats.ranksums(group1_values, group2_values, alternative='two-sided').pvalue
        test_stat = stats.ranksums(group1_values, group2_values, alternative='two-sided').statistic
        # print(f"p-value for All Cells greater than {group}: {p_value:.4g}")
        p_values.append(p_value)
        n1_values.append(len(group1_values))
        n2_values.append(len(group2_values))
        test_statistics.append(test_stat)

        # assembly cells vs non-assembly cells
        group1_values = data[data["Group"] == "Assembly\nCells"]["Values"]
        group1_values = group1_values[~np.isnan(group1_values)]
        group2_values = data[data["Group"] == "Non-Assembly\nCells"]["Values"]
        group2_values = group2_values[~np.isnan(group2_values)]
        p_value = stats.ranksums(group1_values, group2_values, alternative='two-sided').pvalue
        test_stat = stats.ranksums(group1_values, group2_values, alternative='two-sided').statistic
        # print(f"p-value for All Cells greater than {group}: {p_value:.4g}")
        ...
        p_value_array = np.array(p_values)
        corrected_p_value_array = multipletests(p_value_array, alpha=0.05, method='fdr_bh')[1]

        for i, label in enumerate(["Assembly vs. Random Ensembles", "Assembly vs. All Cells", "Assembly vs. Assembly Cells", "Assembly vs. Non-Assembly Cells", "All Cells vs. Assembly Cells", "Assembly Cells vs. Non-Assembly Cells"]):
            print(label)
        ...
        for i, label in enumerate(["Assembly vs. Random Ensembles", "Assembly vs. All Cells", "Assembly vs. Assembly Cells", "Assembly vs. Non-Assembly Cells", "All Cells vs. Assembly Cells", "Assembly Cells vs. Non-Assembly Cells"]):
            print(f"{p_values[i]:.4g}, BH corrected: {corrected_p_value_array[i]:.4g}")

        # Add significance markers as number of asterisks
        for i, p_value in enumerate(corrected_p_value_array):
            if p_value < 0.001:
                significance = 'p < 0.001\n***'
            elif p_value < 0.01:
                significance = 'p < 0.01\n**'
                ...
                significance = 'ns'
            ax.annotate(significance, xy=(i + 1,  1.05), #data[data["Group"] == groups[i]]["Values"].max()
        ...
        plt.tight_layout()
        plt.savefig(f'/home/berteau/neuro/HebbsVision/FigureCode/Figure3/scan{scan}_affinity{affinity}//oracle_scores_dff_all_sets_raincloud.png', dpi = 1200)
        plt.savefig(f'/home/berteau/neuro/HebbsVision/FigureCode/Figure3/scan{scan}_affinity{affinity}//oracle_scores_dff_all_sets_raincloud.pdf')
        plt.savefig(f'/home/berteau/neuro/HebbsVision/FigureCode/Figure3/scan{scan}_affinity{affinity}//oracle_scores_dff_all_sets_raincloud.svg')
        plt.show()
        ...
        # plt.savefig(f'/home/berteau/neuro/HebbsVision/FigureCode/Figure3/scan{scan}_affinity{affinity}//oracle_scores_histogram_dff_all_sets.png', dpi = 1200)
        # # plt.show()
        # plt.close()
        ...
        def plot_ginis2(coactivity_trace, null_trace=None, all_trace=None, a_trace=None, no_a_trace=None):
            ...
            test_stat = stats.ranksums(np.array(gini_values_null).flatten(), np.array(gini_values).flatten(), alternative='less').statistic

            print(f"N: {len(gini_values_null)}/{len(gini_values)}")
            ...
            if a_trace is not None:
                ...
                ax.text(len(labels)-6.0, mean_gini_a+0.01, f'Assembly Cells Mean: {mean_gini_a:.3f}', 
                        color='cornflowerblue', ha='left', va='bottom', fontsize=12, weight='bold')

            if no_a_trace is not None:
                ax.axhline(mean_gini_no_a, color='slategray', linestyle='--', linewidth=2)
                ax.text(0.0, mean_gini_no_a+0.01, f'Nonassembly Cells Mean: {mean_gini_no_a:.3f}', 
                        color='slategray', ha='left', va='bottom', fontsize=12, weight='bold')

            # Add annotations for clarity (optional)
            for p in ax.patches:
                ax.annotate(f'{p.get_height():.2f}', (p.get_x() + p.get_width() / 2., p.get_height()), 
                            ha='center', va='center', xytext=(0, 30.5), textcoords='offset points', size=14, weight='bold', rotation=90)

            plt.legend(bbox_to_anchor=(0, 0.95), loc='upper left', frameon=True, fontsize=12)
            # plt.legend(, loc='upper left', borderaxespad=0.)
            plt.tight_layout()
            plt.savefig(f'/home/berteau/neuro/HebbsVision/FigureCode/Figure3/scan{scan}_affinity{affinity}//sparsity_with_Gini_coefficient_by_assembly_and_random_ensembles.png')
            plt.savefig(f'/home/berteau/neuro/HebbsVision/FigureCode/Figure3/scan{scan}_affinity{affinity}//sparsity_with_Gini_coefficient_by_assembly_and_random_ensembles.pdf')
            plt.savefig(f'/home/berteau/neuro/HebbsVision/FigureCode/Figure3/scan{scan}_affinity{affinity}//sparsity_with_Gini_coefficient_by_assembly_and_random_ensembles.svg')
            ...
            # plt.tight_layout()
            # plt.savefig(f'/home/berteau/neuro/HebbsVision/FigureCode/Figure3/scan{scan}_affinity{affinity}//gini_coefficients_raincloud_plot.png', dpi=1200)
            # plt.savefig(f'/home/berteau/neuro/HebbsVision/FigureCode/Figure3/scan{scan}_affinity{affinity}//gini_coefficients_raincloud_plot.pdf', dpi=1200)
            # plt.savefig(f'/home/berteau/neuro/HebbsVision/FigureCode/Figure3/scan{scan}_affinity{affinity}//gini_coefficients_raincloud_plot.svg', dpi=1200)
            # plt.show()
